...
| [p-068](p-068-recover-remaining-forward-only-fields-and-subfields.md) | Recover remaining forward-only MARC fields and subfields | **active** — Phase 1 shipped: 024 `$q` recovered. Phase 2 complete: 051/055/072 all skipped (no discriminators). Phase 3 pending. |
