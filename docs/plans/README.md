...
| [p-068](p-068-recover-remaining-forward-only-fields-and-subfields.md) | Recover remaining forward-only MARC fields and subfields | **proposed** — 3 subfields with declared emitters but missing from registry (020/024/028 `$q`), plus investigation of 051/055 (item-level classification) and 072 (subject discriminator). |
