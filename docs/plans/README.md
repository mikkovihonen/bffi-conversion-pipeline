...
| [p-066](p-066-devops-ci-release.md) | DevOps: CI coverage, GitHub Pages, releases | **proposed** — coverage badge + auto-publish, MkDocs Material site, release workflow, CHANGELOG, release skill for pi. |
