...
| [p-069](p-069-recover-336-337-338-3-materials-specified.md) | Recover MARC 336/337/338 `$3` (materials specified) subfield | **proposed** — Extend `_RdaEntry` and `_rda_entries` to read `bffi:appliesTo`/`rdfs:label` and emit `$3` for 336/337/338. |
