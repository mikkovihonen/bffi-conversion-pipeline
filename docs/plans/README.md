...
| [p-068](p-068-recover-remaining-forward-only-fields-and-subfields.md) | Recover remaining forward-only MARC fields and subfields | **active** — Phase 1 shipped: 024 `$q` recovered. Phases 2 (051/055/072) and 3 pending. |
