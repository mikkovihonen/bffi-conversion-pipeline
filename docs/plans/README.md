...
| [p-067](p-067-recover-forward-only-marc-fields.md) | Recover MARC fields the XSLT reads but the reverse converter does not emit | **proposed** — 23 forward-only tags recoverable; 9 lost at XSLT, 12 already-documented, 3 `bflc:`-namespace out of scope. |
