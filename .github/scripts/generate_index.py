...
REPO_URL = "https://github.com/mikkovihonen/bffi-conversion-pipeline/blob/main"
README_PATH = Path("README.md")
INDEX_PATH = Path("docs/index.md")

FRONTMATTER = """---
title: BFFI conversion pipeline
description: Bidirectional conversion between MARCXML and BFFI (National Library of Finland's BIBFRAME application profile), by way of BIBFRAME
keywords: marcxml, bibframe, bffi, national-library-of-finland, conversion, round-trip, rdf, turtle, provenance
---
